...
const Bullets = (props) => (
   <ul className={`bullets-container ${Styles.bulletsContainer} `}>
      ...
      <div className={Styles.image}> <img src={props.images[2].url} className={props.images[2].selected ? Styles.withBorder : Styles.noBorder} data-target="#carouselExampleControls" data-slide-to="2" onClick={(e) => props.onSmallImageClick(props.images[2])} /> </div>
